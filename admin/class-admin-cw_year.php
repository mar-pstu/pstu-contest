 ...
 */
class AdminCWYear extends Part {
	...
	public function add_meta_box( $post_type ) {
		if ( 'competitive_work' == $post_type ) {
			add_meta_box(
				...
				__( 'Год проведения', $this->plugin_name ),
	...
	public function render_metabox_content( $post ) {
		...
		if ( is_array( $cw_years ) && ! empty( $cw_years ) ) {
			...
			$control = __( 'Заполните таксономию "Год проведения" или обратитесь к администратору сайта.', $this->plugin_name );
		}
